...
if True :
	...
	np.save('Ex_sol.npy',   u_exact(X,Y,Z).T)
	np.save('appr_sol.npy',   u_poisson)
	np.save('appr_soldx.npy',u_xpoisson)
	np.save('appr_soldy.npy',u_ypoisson)
	np.save('appr_soldz.npy',u_zpoisson)
